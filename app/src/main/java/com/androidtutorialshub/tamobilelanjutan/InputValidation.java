...
public class InputValidation {
    ...
    public boolean isInputEditTextNoHp(TextInputEditText textInputEditText) {
        String value = textInputEditText.getText().toString().trim();
    ...
    public boolean isInputEditTextSamePIN(TextInputEditText textInputEditText, TextInputEditText textInputEditText1, TextInputLayout textInputLayout, String message) {
        String value = textInputEditText.getText().toString().trim();
