...
public class AdminActivity extends AppCompatActivity{
    ...
    private String[] adminitem = new String[]{
            "Ganti PIN","Blokir ATM" };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin);
        lvItem = (ListView) findViewById(R.id.adminlistview);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AdminActivity.this, android.R.layout.simple_list_item_1, android.R.id.text1, adminitem);
        lvItem.setAdapter(adapter);
        lvItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //Toast.makeText(AdminActivity.this, "Memilih : "+adminitem[position], Toast.LENGTH_LONG).show();
        ...
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_admin).setText("Info"),true);
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(tabLayout.getSelectedTabPosition() == 0) {
                    ...
                    startActivity(new Intent(AdminActivity.this, InfoActivity.class));
